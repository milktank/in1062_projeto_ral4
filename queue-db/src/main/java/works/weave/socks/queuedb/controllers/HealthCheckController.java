...
import works.weave.socks.queuedb.entities.HealthCheck;
...
public class HealthCheckController {
    ...
    Map<String, List<HealthCheck>> getHealth() {
        ...
        HealthCheck app = new HealthCheck("queue-db", "OK", dateNow);
        HealthCheck rabbitmq = new HealthCheck("queue-db-rabbitmq", "OK", dateNow);
